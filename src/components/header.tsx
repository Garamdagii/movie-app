...
export const Header = ({}) => {
  ...
  return (
    <div className="flex w-[1440px] px-4 py-3 justify-center items-center">
      <div className="flex justify-between items-center w-[1280px]">
        ...
        <div className="flex gap-3">
          ...
          <div className="flex w-[379px] gap-[10px] px-3 items-center rounded-[8px] border solid border-[#E4E4E7]">
            ...
            <Input
              className={
                "flex py-2 items-center text-sm leading-[20px] text-[#71717A] border-none shadow-none focus-visible:outline-none focus-visible:border-none"
              }
            />
          </div>
        </div>
